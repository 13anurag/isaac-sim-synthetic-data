...
camera1_pos = [(0, 8, 8), (8, 0, 8), (8, 8, 0),]
camera2_pos = [(0, 8, 0), (8, 8, 0), (-8, 8, 0),]
with rep.new_layer():
# Add Default Light
...
position=rep.distribution.sequence(camera1_pos))
with camera2:
rep.modify.pose(look_at=(0,0,0),
position=rep.distribution.sequence(camera2_pos))
